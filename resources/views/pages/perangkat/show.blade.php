                            ...
                            <div class="card-body p-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4 text-center">
                                        @php
                                            $detailImgSrc = $perangkat->foto ? asset('storage/' . $perangkat->foto) : asset('assets-guest/img/no-image.jpg');
                                        @endphp
                                    ...
                                    <div class="col-md-8">
                                        <h5 class="mb-4 text-dark border-start border-4 border-primary ps-3">Informasi Pribadi & Jabatan</h5>
                                        ...
                                        <div class="row detail-row">
                                            ...
                                            <div class="col-sm-8 detail-value">{{ \Carbon\Carbon::parse($perangkat->periode_mulai)->format('d F Y') }}</div>
                                        </div>
                                        ...
                                        <div class="row detail-row">
                                            ...
                                            <div class="col-sm-8 detail-value">
                                                @php
                                                    ...
                                                    $end = $perangkat->periode_selesai ? \Carbon\Carbon::parse($perangkat->periode_selesai) : now();
                                                    $diff = $start->diff($end);
                                                @endphp
                                                {{ $diff->y > 0 ? $diff->y . ' Tahun' : '' }} {{ $diff->m > 0 ? $diff->m . ' Bulan' : '' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if($perangkat->media && $perangkat->media->count() > 0)
                                    <div class="mt-5">
                                        <h5 class="mb-4 text-dark border-start border-4 border-warning ps-3">Galeri & Dokumentasi</h5>
                                                    ...
                                                    <div class="card h-100 border-0 shadow-sm">
                                                        ...
                                                        @if($media->caption)
                                                            <div class="card-footer bg-white p-2 border-top-0">
                                                                <small class="text-muted d-block text-truncate" title="{{ $media->caption }}">
                                                                    {{ $media->caption }}
                                                                </small>
                                                            </div>
                                                        @endif
