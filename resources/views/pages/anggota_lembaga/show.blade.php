                    ...
                    <div class="card-body p-0">
                        <div class="row g-0">
                            ...
                            <div class="col-md-5 bg-light d-flex align-items-center justify-content-center p-4">
                                <div class="text-center w-100">
                                    <div class="mb-3 position-relative d-inline-block">
                                        ...
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{ urlencode($anggota->nama) }}&background=random&size=256"
                            ...
                            <div class="col-md-7 p-4 p-md-5">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-4 text-muted">Nomor Anggota</div>
                                ...
                                <div class="d-flex gap-2 mt-5 pt-3 border-top">
                                    <a href="{{ route('anggota-lembaga.edit', $anggota->id) }}" class="btn btn-warning text-white px-4">
                                        <i class="fa fa-edit me-2"></i>Edit Data
                                    </a>

                                    <form action="{{ route('anggota-lembaga.destroy', $anggota->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data personil ini?');">
                                        @csrf
                                        @method('DELETE')
