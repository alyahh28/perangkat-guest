        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center group hover:transform hover:scale-105 transition duration-300">
                    <div
                        class="bg-green-100 rounded-full w-24 h-24 mx-auto flex items-center justify-center mb-4 group-hover:bg-green-200">
                ...
                <div class="text-center group hover:transform hover:scale-105 transition duration-300">
                    <div
                        class="bg-blue-100 rounded-full w-24 h-24 mx-auto flex items-center justify-center mb-4 group-hover:bg-blue-200">
                ...
                <div class="text-center group hover:transform hover:scale-105 transition duration-300">
                    <div
                        class="bg-yellow-100 rounded-full w-24 h-24 mx-auto flex items-center justify-center mb-4 group-hover:bg-yellow-200">
                ...
                <div class="text-center group hover:transform hover:scale-105 transition duration-300">
                    <div
                        class="bg-red-100 rounded-full w-24 h-24 mx-auto flex items-center justify-center mb-4 group-hover:bg-red-200">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach ($perangkat_desa ?? [] as $index => $perangkat)
                    <div
                        class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
                        <div class="text-center mb-4">
                            <div
                                class="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full mx-auto flex items-center justify-center shadow-md">
            ...
            <div class="text-center mt-8">
                <p class="text-gray-600">
                    Total <span class="font-semibold text-green-600">{{ count($perangkat_desa ?? []) }}</span>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                @foreach ($lembaga_desa ?? [] as $lembaga)
                    <div
                        class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-16 h-16 bg-blue-500 rounded-xl flex items-center justify-center shadow-md">
                                    @if ($lembaga['logo'] ?? false)
                                        <img src="{{ $lembaga['logo'] }}" alt="{{ $lembaga['nama'] }}"
                                            class="w-12 h-12">
                                    @else
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-semibold text-gray-700">{{ $lembaga['jumlah_anggota'] }}
                                                orang</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @foreach ($struktur_wilayah['rw'] ?? [] as $rw)
                            <div
                                ...
                                <span class="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-semibold">
                                    {{ count(array_filter($struktur_wilayah['rt'] ?? [], function ($rt) use ($rw) {return $rt['rw'] === $rw['nomor'];})) }}
                                    RT
                                </span>
                            </div>
                        @endforeach
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @foreach ($struktur_wilayah['rt'] ?? [] as $rt)
                            <div
                                class="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition duration-300">
                                <div class="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center mr-3">
                                    <span class="text-white font-bold text-sm">RT</span>
                                </div>
                                <div class="flex-1">
                                    <h4 class="font-semibold text-gray-800">RT {{ $rt['nomor'] }}/RW
                                        {{ $rt['rw'] }}</h4>
