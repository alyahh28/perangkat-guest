...
<head>
    ...
    <style>
        ...
        .login-container { background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); width: 350px; }
...
<body>
    <div class="login-container">
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                @error('password')
                    <span class="text-error">{{ $message }}</span>
                @enderror
                <small style="display: block; margin-top: 5px; color: #6c757d;">Min. 3 kar. & harus ada huruf kapital.</small>
            </div>
        ...
        <p style="text-align: center; margin-top: 20px; font-size: 0.9em;">
            💡 Contoh Username: <strong>guest</strong> | Password: <strong>Guest123</strong>
        </p>
    </div>
</body>
</html>