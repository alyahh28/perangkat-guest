        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-4">
                        <img class="img-fluid" src="{{ asset('assets-guest/img/portfolio-4.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ asset('assets-guest/img/portfolio-5.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ asset('assets-guest/img/portfolio-6.jpg') }}" alt="Image">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">BINA DESA</a>, All Right Reserved.
