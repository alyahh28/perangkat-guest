...
<head>
    <meta charset="utf-8">
    <title>Tambah Warga - SEO Master</title>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-lg-12 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">Tambah Data Warga</h1>
                            <p class="text-white pb-3 animated zoomIn">Form untuk menambahkan data warga baru</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow">
                            <div class="card-header bg-primary text-white">
                                <h4 class="mb-0">Form Tambah Warga</h4>
                            </div>
                            <div class="card-body">
