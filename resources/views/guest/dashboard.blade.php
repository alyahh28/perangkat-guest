            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{ url('/warga') }}" class="nav-item nav-link">Warga</a>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s"
                            src="{{ asset('assets-guest/img/about.jpg') }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center" style="height: 250px;">
                    ...
                    <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                        <img class="img-fluid mt-5" style="height: 250px;"
                            src="{{ asset('assets-guest/img/newsletter.png') }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="owl-carousel testimonial-carousel">
                    ...
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle"
                                src="{{ asset('assets-guest/img/testimonial-4.jpg') }}"
                                style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h6 class="text-white mb-1">Client Name</h6>
                                <small>Profession</small>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('assets-guest/img/portfolio-4.jpg') }}"
                                    alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('assets-guest/img/portfolio-5.jpg') }}"
                                    alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('assets-guest/img/portfolio-6.jpg') }}"
                                    alt="Image">
                            </div>
                        </div>
                    </div>
