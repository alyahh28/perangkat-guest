...
<head>
    ...
    <!-- Fonts and icons -->
    <script src="{{ asset('assets-guest/js/plugin/webfont/webfont.min.js') }}"></script>
    <script>
        WebFont.load({
            google: {
    ...
    <link rel="stylesheet" href="{{ asset('assets-guest/css/plugins.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets-guest/css/kaiadmin.min.css') }}" />

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link rel="stylesheet" href="{{ asset('assets-guest/css/demo.css') }}" />
</head>
            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo">
                        <img src="{{ asset('assets-guest/img/kaiadmin/logo_light.svg') }}" alt="navbar brand"
